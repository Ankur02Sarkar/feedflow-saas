...
const features = [
  ...
  {
    title: 'Customizable',
    description: 'Customize FeedFlow to fit your needs and preferences.',
    icon: 'icon-2',
  },
  {
    title: 'Analytics',
  ...
  {
    title: 'Secure',
    description: 'Your data is safe and secure with FeedFlow.',
  },
  {
    title: 'Scalable',
    description: 'Grow your business with FeedFlow as you scale.',
  },
  {
    title: 'Fast Support',
